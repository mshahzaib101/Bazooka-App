...
class ClothingContainer extends Component {
    ...
    render() {
        return(
            <div>
                <DisplayImg displayTextonImg='Clothing' />
                <h3 className='trend2'><span className='subtrend2'>NEW</span> ARRIVALS</h3>
             ...
             
                {
                    this.props.addsDataFromStore.Adds_Data.map(
                        (data, index) => {
                            ...
                            return(
                            <AdCard adTitle={a.adTitle} adDecription={a.adDescription} city={a.city} date={a.dateOfPublish} publisherName={a.name} phoneNumber={a.phoneNumber} price={a.price} productId={a.productId} productimg={a.productImgStorageURL} userUid={a.userUid} category={a.category} />
                        )}
                        }
                        )
                }
               ...
               {/* { console.log(this.props.addsDataFromStore.Adds_Data)}
               {console.log('3 data in render')} */}
            </div>
        )
    }
}
